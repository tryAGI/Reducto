...
namespace Reducto
{
    public partial class ReductoClient
    {
        ...
        private static readonly global::Reducto.EndPointSecurityRequirement s_SplitAsyncSplitAsyncPostSecurityRequirement0 =
        ...
        private static readonly global::Reducto.EndPointSecurityRequirement[] s_SplitAsyncSplitAsyncPostSecurityRequirements =
            new global::Reducto.EndPointSecurityRequirement[]
            {                s_SplitAsyncSplitAsyncPostSecurityRequirement0,
            };
        partial void PrepareSplitAsyncSplitAsyncPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Reducto.ConfigV3AsyncSplitConfig request);
        partial void PrepareSplitAsyncSplitAsyncPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Reducto.ConfigV3AsyncSplitConfig request);
        partial void ProcessSplitAsyncSplitAsyncPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSplitAsyncSplitAsyncPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Reducto.AsyncSplitResponse> SplitAsyncSplitAsyncPostAsync(

            global::Reducto.ConfigV3AsyncSplitConfig request,
            global::Reducto.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await SplitAsyncSplitAsyncPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reducto.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reducto.AutoSDKHttpResponse<global::Reducto.AsyncSplitResponse>> SplitAsyncSplitAsyncPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSplitAsyncSplitAsyncPostArguments(
            ...
            var __authorizations = global::Reducto.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SplitAsyncSplitAsyncPostSecurityRequirements,
                operationName: "SplitAsyncSplitAsyncPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSplitAsyncSplitAsyncPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Reducto.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Reducto.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SplitAsyncSplitAsyncPost",
                                methodName: "SplitAsyncSplitAsyncPostAsync",
                                pathTemplate: "\"/split_async\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSplitAsyncSplitAsyncPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Reducto.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSplitAsyncSplitAsyncPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Reducto.AsyncSplitResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Reducto.AutoSDKHttpResponse<global::Reducto.AsyncSplitResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Reducto.AsyncSplitResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await SplitAsyncSplitAsyncPostAsync(
                request: __request,
                requestOptions: requestOptions,
