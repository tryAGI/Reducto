...
namespace Reducto
{
    public partial class ReductoClient
    {
        ...
        private static readonly global::Reducto.EndPointSecurityRequirement s_ExtractAsyncExtractAsyncPostSecurityRequirement0 =
        ...
        private static readonly global::Reducto.EndPointSecurityRequirement[] s_ExtractAsyncExtractAsyncPostSecurityRequirements =
            new global::Reducto.EndPointSecurityRequirement[]
            {                s_ExtractAsyncExtractAsyncPostSecurityRequirement0,
            };
        partial void PrepareExtractAsyncExtractAsyncPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Reducto.AsyncExtractConfig request);
        partial void PrepareExtractAsyncExtractAsyncPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Reducto.AsyncExtractConfig request);
        partial void ProcessExtractAsyncExtractAsyncPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessExtractAsyncExtractAsyncPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Reducto.AsyncExtractResponse> ExtractAsyncExtractAsyncPostAsync(

            global::Reducto.AsyncExtractConfig request,
            global::Reducto.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ExtractAsyncExtractAsyncPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reducto.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reducto.AutoSDKHttpResponse<global::Reducto.AsyncExtractResponse>> ExtractAsyncExtractAsyncPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareExtractAsyncExtractAsyncPostArguments(
            ...
            var __authorizations = global::Reducto.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ExtractAsyncExtractAsyncPostSecurityRequirements,
                operationName: "ExtractAsyncExtractAsyncPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareExtractAsyncExtractAsyncPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Reducto.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Reducto.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ExtractAsyncExtractAsyncPost",
                                methodName: "ExtractAsyncExtractAsyncPostAsync",
                                pathTemplate: "\"/extract_async\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessExtractAsyncExtractAsyncPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Reducto.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessExtractAsyncExtractAsyncPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Reducto.AsyncExtractResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Reducto.AutoSDKHttpResponse<global::Reducto.AsyncExtractResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Reducto.AsyncExtractResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Reducto.AsyncExtractResponse> ExtractAsyncExtractAsyncPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Reducto.AsyncExtractConfig
            {
                Async = async,
                Input = input,
                Parsing = parsing,
            ...
            return await ExtractAsyncExtractAsyncPostAsync(
                request: __request,
                requestOptions: requestOptions,
