...
namespace Reducto
{
    public partial class ReductoClient
    {
        ...
        private static readonly global::Reducto.EndPointSecurityRequirement s_WebhookPortalConfigureWebhookPostSecurityRequirement0 =
        ...
        private static readonly global::Reducto.EndPointSecurityRequirement[] s_WebhookPortalConfigureWebhookPostSecurityRequirements =
            new global::Reducto.EndPointSecurityRequirement[]
            {                s_WebhookPortalConfigureWebhookPostSecurityRequirement0,
            };
        partial void PrepareWebhookPortalConfigureWebhookPostArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareWebhookPortalConfigureWebhookPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessWebhookPortalConfigureWebhookPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWebhookPortalConfigureWebhookPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> WebhookPortalConfigureWebhookPostAsync(
            global::Reducto.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await WebhookPortalConfigureWebhookPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reducto.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reducto.AutoSDKHttpResponse<string>> WebhookPortalConfigureWebhookPostAsResponseAsync(
            global::Reducto.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWebhookPortalConfigureWebhookPostArguments(
                httpClient: HttpClient);


            var __authorizations = global::Reducto.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_WebhookPortalConfigureWebhookPostSecurityRequirements,
                operationName: "WebhookPortalConfigureWebhookPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWebhookPortalConfigureWebhookPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Reducto.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Reducto.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WebhookPortalConfigureWebhookPost",
                                methodName: "WebhookPortalConfigureWebhookPostAsync",
                                pathTemplate: "\"/configure_webhook\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWebhookPortalConfigureWebhookPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Reducto.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWebhookPortalConfigureWebhookPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Reducto.AutoSDKHttpResponse<string>(
                                        statusCode: __response.StatusCode,
