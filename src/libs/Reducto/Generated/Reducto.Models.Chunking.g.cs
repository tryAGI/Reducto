...
namespace Reducto
{
    ...
    public sealed partial class Chunking
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Reducto.JsonConverters.ChunkingChunkModeJsonConverter))]
        public global::Reducto.ChunkingChunkMode? ChunkMode { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Chunking" /> class.
        /// </summary>
...
#endif
        public Chunking(
            global::Reducto.ChunkingChunkMode? chunkMode,
            int? chunkSize,
            int? chunkOverlap)
        {
