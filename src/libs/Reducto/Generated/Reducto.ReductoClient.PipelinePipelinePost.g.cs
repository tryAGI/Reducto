...
namespace Reducto
{
    public partial class ReductoClient
    {
        ...
        private static readonly global::Reducto.EndPointSecurityRequirement s_PipelinePipelinePostSecurityRequirement0 =
        ...
        private static readonly global::Reducto.EndPointSecurityRequirement[] s_PipelinePipelinePostSecurityRequirements =
            new global::Reducto.EndPointSecurityRequirement[]
            {                s_PipelinePipelinePostSecurityRequirement0,
            };
        partial void PreparePipelinePipelinePostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Reducto.V3PipelineConfig request);
        partial void PreparePipelinePipelinePostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Reducto.V3PipelineConfig request);
        partial void ProcessPipelinePipelinePostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPipelinePipelinePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Reducto.PipelineResponse> PipelinePipelinePostAsync(

            global::Reducto.V3PipelineConfig request,
            global::Reducto.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PipelinePipelinePostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reducto.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reducto.AutoSDKHttpResponse<global::Reducto.PipelineResponse>> PipelinePipelinePostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePipelinePipelinePostArguments(
            ...
            var __authorizations = global::Reducto.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PipelinePipelinePostSecurityRequirements,
                operationName: "PipelinePipelinePostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePipelinePipelinePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Reducto.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Reducto.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PipelinePipelinePost",
                                methodName: "PipelinePipelinePostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPipelinePipelinePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Reducto.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPipelinePipelinePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Reducto.PipelineResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Reducto.AutoSDKHttpResponse<global::Reducto.PipelineResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Reducto.PipelineResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Reducto.PipelineResponse> PipelinePipelinePostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Reducto.V3PipelineConfig
            {
                Input = input,
            ...
            return await PipelinePipelinePostAsync(
                request: __request,
                requestOptions: requestOptions,
