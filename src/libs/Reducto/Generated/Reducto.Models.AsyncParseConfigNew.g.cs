...
namespace Reducto
{
    ...
    public sealed partial class AsyncParseConfigNew
    {
        ...
        /// <summary>
        /// Queue priority. 'batch' places the job in a lower-priority queue that runs when spare GPU capacity is available.<br/>
        /// Default Value: auto
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AsyncParseConfigNew" /> class.
        /// </summary>
