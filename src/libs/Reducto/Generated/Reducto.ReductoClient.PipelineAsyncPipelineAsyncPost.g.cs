...
namespace Reducto
{
    public partial class ReductoClient
    {
        ...
        private static readonly global::Reducto.EndPointSecurityRequirement s_PipelineAsyncPipelineAsyncPostSecurityRequirement0 =
        ...
        private static readonly global::Reducto.EndPointSecurityRequirement[] s_PipelineAsyncPipelineAsyncPostSecurityRequirements =
            new global::Reducto.EndPointSecurityRequirement[]
            {                s_PipelineAsyncPipelineAsyncPostSecurityRequirement0,
            };
        partial void PreparePipelineAsyncPipelineAsyncPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Reducto.V3AsyncPipelineConfig request);
        partial void PreparePipelineAsyncPipelineAsyncPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Reducto.V3AsyncPipelineConfig request);
        partial void ProcessPipelineAsyncPipelineAsyncPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPipelineAsyncPipelineAsyncPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Reducto.AsyncPipelineResponse> PipelineAsyncPipelineAsyncPostAsync(

            global::Reducto.V3AsyncPipelineConfig request,
            global::Reducto.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PipelineAsyncPipelineAsyncPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reducto.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reducto.AutoSDKHttpResponse<global::Reducto.AsyncPipelineResponse>> PipelineAsyncPipelineAsyncPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePipelineAsyncPipelineAsyncPostArguments(
            ...
            var __authorizations = global::Reducto.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PipelineAsyncPipelineAsyncPostSecurityRequirements,
                operationName: "PipelineAsyncPipelineAsyncPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePipelineAsyncPipelineAsyncPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Reducto.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Reducto.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PipelineAsyncPipelineAsyncPost",
                                methodName: "PipelineAsyncPipelineAsyncPostAsync",
                                pathTemplate: "\"/pipeline_async\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPipelineAsyncPipelineAsyncPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Reducto.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPipelineAsyncPipelineAsyncPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Reducto.AsyncPipelineResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Reducto.AutoSDKHttpResponse<global::Reducto.AsyncPipelineResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Reducto.AsyncPipelineResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PipelineAsyncPipelineAsyncPostAsync(
                request: __request,
                requestOptions: requestOptions,
