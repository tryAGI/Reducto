...
namespace Reducto
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Reducto.AutoSDKRetryOptions Retry { get; set; } = new global::Reducto.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Reducto.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Reducto.IAutoSDKHook>();
        ...
        public global::Reducto.AutoSDKClientOptions AddHook(
            global::Reducto.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Reducto.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Reducto.AutoSDKClientOptions UseAuthorizationProvider(
            global::Reducto.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Reducto.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Reducto.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Reducto.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Reducto.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Reducto.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Reducto.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Reducto.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Reducto.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Reducto.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Reducto.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Reducto.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Reducto.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Reducto.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Reducto.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Reducto.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Reducto.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Reducto.AutoSDKClientOptions clientOptions,
            global::Reducto.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Reducto.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Reducto.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Reducto.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Reducto.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Reducto.IAutoSDKHook, global::Reducto.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Reducto.AutoSDKHookContext context)
        {
