...
namespace Reducto
{
    public partial class ReductoClient
    {
        ...
        private static readonly global::Reducto.EndPointSecurityRequirement s_EditAsyncEditAsyncPostSecurityRequirement0 =
        ...
        private static readonly global::Reducto.EndPointSecurityRequirement[] s_EditAsyncEditAsyncPostSecurityRequirements =
            new global::Reducto.EndPointSecurityRequirement[]
            {                s_EditAsyncEditAsyncPostSecurityRequirement0,
            };
        ...
        {
            var __response = await EditAsyncEditAsyncPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reducto.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reducto.AutoSDKHttpResponse<global::Reducto.AsyncEditResponse>> EditAsyncEditAsyncPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Reducto.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditAsyncEditAsyncPostSecurityRequirements,
                operationName: "EditAsyncEditAsyncPostAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Reducto.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Reducto.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EditAsyncEditAsyncPost",
                                methodName: "EditAsyncEditAsyncPostAsync",
                                pathTemplate: "\"/edit_async\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Reducto.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Reducto.AsyncEditResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Reducto.AutoSDKHttpResponse<global::Reducto.AsyncEditResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Reducto.AsyncEditResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
