...
namespace Reducto
{
    public partial class ReductoClient
    {
        ...
        private static readonly global::Reducto.EndPointSecurityRequirement s_ExtractExtractPostSecurityRequirement0 =
        ...
        private static readonly global::Reducto.EndPointSecurityRequirement[] s_ExtractExtractPostSecurityRequirements =
            new global::Reducto.EndPointSecurityRequirement[]
            {                s_ExtractExtractPostSecurityRequirement0,
            };
        partial void PrepareExtractExtractPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Reducto.OneOf<global::Reducto.SyncExtractConfig, global::Reducto.AsyncExtractConfig> request);
        partial void PrepareExtractExtractPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Reducto.OneOf<global::Reducto.SyncExtractConfig, global::Reducto.AsyncExtractConfig> request);
        partial void ProcessExtractExtractPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessExtractExtractPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await ExtractExtractPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reducto.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reducto.AutoSDKHttpResponse<global::Reducto.OneOf<global::Reducto.V3ExtractResponse, global::Reducto.AsyncExtractResponse>>> ExtractExtractPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareExtractExtractPostArguments(
            ...
            var __authorizations = global::Reducto.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ExtractExtractPostSecurityRequirements,
                operationName: "ExtractExtractPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareExtractExtractPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Reducto.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Reducto.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ExtractExtractPost",
                                methodName: "ExtractExtractPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessExtractExtractPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Reducto.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessExtractExtractPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Reducto.OneOf<global::Reducto.V3ExtractResponse, global::Reducto.AsyncExtractResponse>.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Reducto.AutoSDKHttpResponse<global::Reducto.OneOf<global::Reducto.V3ExtractResponse, global::Reducto.AsyncExtractResponse>>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Reducto.OneOf<global::Reducto.V3ExtractResponse, global::Reducto.AsyncExtractResponse>.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ExtractExtractPostAsync(
                request: __request,
                requestOptions: requestOptions,
